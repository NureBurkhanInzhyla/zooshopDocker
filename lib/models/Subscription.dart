...
Future<List<SubscriptionDTO>> fetchSubscriptionsByUserId(int userId) async {
  final response = await http.get(
    Uri.parse('https://zooshop-dnu7.onrender.com/api/Subscription/user$userId'),
  );
...
Future<void> createSubscription(SubscriptionDTO subscription) async {
  final url = Uri.parse('https://zooshop-dnu7.onrender.com/api/Subscription');
...
Future<void> deleteSubscriptionById(int subscriptionId) async {
  final url = Uri.parse('https://zooshop-dnu7.onrender.com/api/Subscription/$subscriptionId');
