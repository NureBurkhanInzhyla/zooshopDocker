...
Future<List<Cart>> fetchCartsByUserId(int userId) async {
  final response = await http.get(Uri.parse('https://zooshop-dnu7.onrender.com/api/Cart/$userId'));
...
Future<void> addToCart(Cart cart) async {
  final url = Uri.parse('https://zooshop-dnu7.onrender.com/api/Cart');
...
Future<void> deleteProductFromCart(int userId, int productId) async {
  final url = Uri.parse('https://zooshop-dnu7.onrender.com/api/Cart/DeleteProduct/$userId/$productId');
...
Future<void> clearCart(int userId) async {
  final url = Uri.parse('https://zooshop-dnu7.onrender.com/api/Cart/ClearCart/$userId');
