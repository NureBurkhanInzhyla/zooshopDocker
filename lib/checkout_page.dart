      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildRadioOption(
              'Доставка кур’єром\nпо м. Київ, от 500 грн - безкоштовно',
              'courier',
            ),
            _buildRadioOption(
              'Самовивіз\nвул. Полтавський шлях 6 А - магазин зоотоварів "Пухнастик"',
              'pickup',
            ),
            _buildRadioOption(
              'Нова Пошта\nвід 500 грн (за передплатою) - безкоштовно',
              'nova',
            ),
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                DropdownMenuItem(value: 'cash', child: Text('Готівкою при отриманні')),
                DropdownMenuItem(value: 'card', child: Text('Оплата картою')),
              ],
